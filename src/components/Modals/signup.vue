                    ...
                    <div>
                        ...
                        <form @submit.prevent="handleSubmit">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" v-model="user.dob" id="dob" name="dob" class="form-control" :class="{ 'is-invalid': submitted && $v.user.dob.$error }" />
                                <div v-if="submitted && $v.user.email.$error" class="invalid-feedback">
                            ...
                            <div class="form-group">
                                <button class="btn btn-primary"><center>Register</center></button>
                            </div>
                        </form>
                    </div>
                </div>
